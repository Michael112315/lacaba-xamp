...
<body>
  ...
  <div class="container-fluid">
      ...
      <img src="download.jfif" alt="Avatar Logo" style="width:40px;" class="rounded-pill"> 
    ...
    <button class="navbar-toggler" type="LOGOUT" data-bs-toggle="collapse" data-bs-target="#collapsibleNavbar">
...
<img src="kape.jpg" class="img-rounded" style="height: auto" width="auto"  alt="kape.jpg"> 
